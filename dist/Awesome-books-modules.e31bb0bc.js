...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"modules/book-class.js":[function(require,module,exports) {
"use strict";
...
var BookList = /*#__PURE__*/function () {
  function BookList() {
  ...
  _createClass(BookList, [{
    key: "addBooks",
    value: function addBooks(title, author) {
    ...
    key: "deleteBooks",
    value: function deleteBooks(index) {
    ...
    value: function displayBooks() {
      ...
      bookSection.innerHTML = this.collection.map(function (book) {
        return "\n        <tr>\n            <td>\"".concat(book.title, "\" by ").concat(book.author, "</td>\n            <td><button type=\"button\" class=\"btn btn-primary remove\" >remove</button></td>\n            \n        </tr>\n        ");
      }).join('');
      var bookItems = document.querySelectorAll('.remove');
      bookItems.forEach(function (bookItem) {
        bookItem.addEventListener('click', _this.deleteBooks.bind(_this));
      });
...
},{}],"modules/form-submit.js":[function(require,module,exports) {
"use strict";
...
exports.default = add;
var _bookClass = _interopRequireDefault(require("./book-class.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function add() {
  console.log("hey");
  var newBook = new _bookClass.default();
...
},{"./book-class.js":"modules/book-class.js"}],"modules/navigation-links.js":[function(require,module,exports) {
"use strict";
...
function navbar() {
  var myLinksContainer = document.getElementById('list');
  var addContainer = document.getElementById('new');
  var contactContainer = document.getElementById('contact');
  var list = document.getElementById('book-list');
  var bookForm = document.getElementById('book-form');
  var contactInfo = document.getElementById('contact-info');
  myLinksContainer.addEventListener('click', function () {
...
},{}],"modules/luxon.js":[function(require,module,exports) {
"use strict";
...
},{}],"modules/datetime.js":[function(require,module,exports) {
"use strict";
...
var _luxon = _interopRequireDefault(require("./luxon.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function date() {
  var now = _luxon.default.now();
  return now;
}
},{"./luxon.js":"modules/luxon.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _formSubmit = _interopRequireDefault(require("./modules/form-submit.js"));
var _bookClass = _interopRequireDefault(require("./modules/book-class.js"));
var _navigationLinks = _interopRequireDefault(require("./modules/navigation-links.js"));
var _datetime = _interopRequireDefault(require("./modules/datetime.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
console.log((0, _datetime.default)());
var newBook = new _bookClass.default();
document.getElementById('submit-button').addEventListener('click', function () {
  return (0, _formSubmit.default)();
});
newBook.displayBooks();
(0, _navigationLinks.default)();
},{"./modules/form-submit.js":"modules/form-submit.js","./modules/book-class.js":"modules/book-class.js","./modules/navigation-links.js":"modules/navigation-links.js","./modules/datetime.js":"modules/datetime.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
